...
"""
 ...
 Traceback (most recent call last):
  File "D:/Coding/mypython/pythonstudy2022/moviepy-study/cool_text_effect.py", line 56, in <module>
    grad = color_gradient(moving_txt.size, p1=(0, 2 * h / 3),
  File "C:\python3\lib\site-packages\moviepy\video\tools\drawing.py", line 147, in color_gradient
    if vector:
...
"""
from conf import DATA_OUTPUTS, DATA_INPUTS
import numpy as np
...
clip_txt = TextClip(txt, color='white', align='West', fontsize=25,
                    font='Candara-Bold-Italic', method='label')
...
stars = ImageClip(os.path.join(DATA_INPUTS, 'stars.jpg')).resize(width=720)
...
concatenate_videoclips(annotated_clips).write_videofile(os.path.join(DATA_OUTPUTS, 'cool_text_effect.mp4'), fps=5)